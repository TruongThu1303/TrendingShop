		...
		<header class="flex justify-between pt-1">
			...
			<div >
				...
				<div  class="flex space-x-2" >
				    ...
				    <a href="?role=admin" class="mx-4 mb-11 mt-3 border-2 rounded-lg hover:bg-orange-400 hover:text-white hover:font-bold text-orange-500 p-2"><span>Đăng nhập</span></a>
				</div>
			</div>
			<!--end tìm kiếm-->
...
<div class="grid grid-cols-6" id="product">
					...
					<?php
						foreach ($production_id as $production){
							extract($production);
							$hinhpath="upload/img/".$img;
								...
								<div class="product-content-right">
								  <div class="tensp">
									...
									<!-- ảnh tròn -->
								   <div class="chonmau">
									<img src="https://bizweb.sapocdn.net/thumb/small/100/438/408/products/van5196-hog02.jpg?v=1657698086847" alt="">
									<img src="https://bizweb.sapocdn.net/thumb/small/100/438/408/products/van5196-vag03.jpg?v=1657698086847" alt="">
									<img src="https://bizweb.sapocdn.net/thumb/small/100/438/408/products/van5196-cam06.jpg?v=1657698086847" alt="">
								   </div>
				
								   <div class="chon-size">
									<p class="chon-size">Kích thước: S</p>
									<img src="https://bizweb.sapocdn.net/100/438/408/themes/863105/assets/size.svg?1658915788098" alt="" class="chon-size">
									<p class="chon-size">Gợi ý tìm size</p>
									<a href="" style="color:#fcaf17 ;" class="chon-size">Bảng size chuẩn</a>
								   </div>
				
				
								  <div class="luachonsize">
									<!-- Sử dụng bootstrap -->
									<div class="form-check form-check-inline">
									  <input class="form-check-input" type="radio" name="inlineRadioOptions" id="S" value="option1">
									...
									<div class="form-check form-check-inline">
									  <input class="form-check-input" type="radio" name="inlineRadioOptions" id="L" value="option3">
									...
									<div class="chonsoluong">
									  ...
									  <div class="buttons_added">
										...
										<input aria-label="quantity" class="input-qty" max="99" min="1" name="" type="number" value="1">
								   ...
								   <div class="button">
									<a href="?role=client&mod=cart&action=bill" <button type="button" id="muangay" class="btn btn-outline-warning btn-lg"><span >Mua ngay</span></button></a>
									
									<button type="button" id="themvaogiohang" class="btn btn-outline-warning btn-lg"><a href="?role=client&mod=cart&id_production='.$id.'">
									<i class="fas fa-cart-plus"></i> Thêm vào giỏ hàng </a></button>
								   </div>
				
								   <div class="thongtinshop">
									<div class="info-sdt">
										<a href="#" class="sodienthoai"><img src="https://bizweb.sapocdn.net/100/438/408/themes/863105/assets/number_phone_yellow.png?1659002941894" alt="" class="icon-sdt"><span class="goidatmua">Gọi đặt mua: 02499966868</span></a>
									</div>
				
									<div class="info-diachi">
									  <a href="#" class="diachi"><img src="https://bizweb.sapocdn.net/100/438/408/themes/863105/assets/location_yellow.png?1659002941894" alt="" class="icon-location"><span class="timdiachi">Tìm shop gần bạn nhất</span></a>
									</div>
								   </div>
								   ...
								   <div class="shipcod">
									<button>
									  <a href="" class="shipcod" style="text-decoration:none ;">
										<img src="https://bizweb.sapocdn.net/100/438/408/themes/863105/assets/ser_1.png?1658650672344" alt="">
										<p style="color:black ;">Miễn phí vận chuyển đơn 0đ <br>
										<span style="color:#fcaf17 ;">FREESHIP</span>   mọi đơn hàng từ 30/6-31/7
										</p>
											</a>
									</button>
				
									<button class="mienphiship">
									  <a href="" class="shipcod" style="text-decoration:none ;">
										<img src="https://bizweb.sapocdn.net/100/438/408/themes/863105/assets/ser_1.png?1658650672344" alt="">
										<p style="color:black ;">Miễn phí vận chuyển đơn 0đ <br>
										<span style="color:#fcaf17 ;">FREESHIP</span>   mọi đơn hàng từ 30/6-31/7
								   ...
								   <div class="chinhsachvc">
									<button class="btn-chinhsachvc">
									  <a href="https://yody.vn/chinh-sach-khach-hang-than-thiet" class="chinhsachvc" style="text-decoration:none ;">
										<img src="https://bizweb.sapocdn.net/100/438/408/themes/863105/assets/ser_3.png?1658650672344" alt="">
									<p style="color:black ;" >
									 Khách hàng VIP <br>
									Ưu đãi dành cho  <span style="color:#fcaf17 ;">khách hàng VIP</span>  
									</p>
									</a>
									</button>
									...
									<button class="hotrobaohanh">
									  <a href="https://yody.vn/chinh-sach-doi-tra" class="chinhsachvc" style="text-decoration:none ;">
										<img src="https://bizweb.sapocdn.net/100/438/408/themes/863105/assets/ser_4.png?1658650672344" alt="">
									<p style="color:black ;">
										Hỗ trợ bảo hành <br>
									<span style="color:#fcaf17;"> Dễ dàng đổi, sửa sản phẩm</span>  tại YODY Store
									</p>
									</a>
									</div>
									</button>
								   ...
								   <div class="doitra">
									<i class="fas fa-bolt"></i> <span class="mienphidoitra">Miễn phí đổi trả 15 ngày</span>
								   </div>
				...
				<hr>
							...
							<!-- đánh giá  -->
							<p class="name" style="color:#fcaf17 ;"> Đánh Giá Sản Phẩm</p>
    ...
    <div class="d-flex justify-content-center row">
        <div class="col-md-8">
            <div class="d-flex flex-column comment-section">
				<form action="?role=client&mod=detail&action=addComment&id_production=<?= $production['id'] ?>" method="post">
				<?php foreach ($comments as $cmt){ ?>
					
					<div class="bg-white p-2">
						<div class="d-flex flex-row ">
							<div class="d-flex flex-column justify-content-start ml-2"><span class="d-block font-weight-bold name"><?= $cmt['full_name'] ?></span><span class="date text-black-50"><?= $cmt['date'] ?></span></div>
						</div>
						<div class="mt-2">
							<p class="comment-text"><?= $cmt['detail'] ?></p>
						</div>
					</div>
				...
				<div class="bg-light p-2">
					<div class="text-orange-400 font-bold py-2 px-2">BÌNH LUẬN</div>
						<div class="d-flex flex-row align-items-start"><input  name="detail" class="form-control ml-1 shadow-none textarea"></div>
						<div class="mt-2 text-right">
							<button  class="btn btn-danger btn-sm btn-outline-danger shadow-none" type="submit">Gửi</button></div>
					</div>
				</form>
			...
			<p class="name" style="color:#fcaf17 ;">CÓ THỂ BẠN MUỐN MUA</p>					
	...
	<aside>
		...
		<?php foreach ($productions as $production){
                                ...
                                echo '<div class="products col-2 mr-28 border-2 border-black-600 hover:border-red-600 hover:border-4 mt-3">
