                        ...
                        <tbody>
                            <?php foreach ($bills as $bill) : ?>
                                <tr>
                                    ...
                                    <td><?php echo ($bill['numberphone']) ?></td>
                                    <td>
                                        <span style="overflow: visible; position: relative; width: 125px;">
                                            <a href="?role=admin&mod=cart&action=detail&id=<?php echo $bill['id'] ?>" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details"> <span class="svg-icon svg-icon-md"> <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
